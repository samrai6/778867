...
AUTH_CHANNEL = [int(auth_channel) for auth_channel in environ.get('AUTH_CHANNEL', '-1002907277634').split() if id_pattern.search(auth_channel)]
...
DATABASE_NAME = environ.get('DATABASE_NAME', "SKR")
